    ...
    <div>
      ...
      <Grid container>
        ...
        <Grid item xs={11}>
          <CardHeader
            ...
            title={applist[7].appName}
            subheader={applist[7].publisherName}
          />
        </Grid>
      </Grid>
      <div class="table-responsive">
        <table class="dtab">
          ...
          {index.map((i) => (
            <tr className="drow">
              <td className="dtable">{appdata[8][i].date}</td>
              <td className="dtable">{appdata[8][i].revenue}</td>
              <td className="dtable">{appdata[8][i].adRequest}</td>
              <td className="dtable">{appdata[8][i].adResponse}</td>
              <td className="dtable">{appdata[8][i].impressions}</td>
              <td className="dtable">{appdata[8][i].clicks}</td>
              <td className="dtable">
                {(
                  (appdata[8][i].impressions / appdata[8][i].adResponse) *
                  100
                ).toFixed(2)}
                %
              </td>
