    ...
    <div>
      ...
      <Grid container>
        ...
        <Grid item xs={11}>
          <CardHeader
            ...
            title={applist[3].appName}
            subheader={applist[3].publisherName}
          />
        </Grid>
      </Grid>
      <div class="table-responsive">
        <table class="dtab">
          ...
          {index.map((i) => (
            <tr className="drow">
              <td className="dtable">{appdata[4][i].date}</td>
              <td className="dtable">{appdata[4][i].revenue}</td>
              <td className="dtable">{appdata[4][i].adRequest}</td>
              <td className="dtable">{appdata[4][i].adResponse}</td>
              <td className="dtable">{appdata[4][i].impressions}</td>
              <td className="dtable">{appdata[4][i].clicks}</td>
              <td className="dtable">
                {(
                  (appdata[4][i].impressions / appdata[4][i].adResponse) *
                  100
                ).toFixed(2)}
                %
              </td>
