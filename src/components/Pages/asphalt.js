    ...
    <div>
      ...
      <Grid container>
        ...
        <Grid item xs={11}>
          <CardHeader
            ...
            title={applist[9].appName}
            subheader={applist[9].publisherName}
          />
        </Grid>
      </Grid>
      <div class="table-responsive">
        <table class="dtab">
          ...
          {index.map((i) => (
            <tr className="drow">
              <td className="dtable">{appdata[10][i].date}</td>
              <td className="dtable">{appdata[10][i].revenue}</td>
              <td className="dtable">{appdata[10][i].adRequest}</td>
              <td className="dtable">{appdata[10][i].adResponse}</td>
              <td className="dtable">{appdata[10][i].impressions}</td>
              <td className="dtable">{appdata[10][i].clicks}</td>
              <td className="dtable">
                {(
                  (appdata[10][i].impressions / appdata[10][i].adResponse) *
                  100
                ).toFixed(2)}
                %
              </td>
