    ...
    <div>
      ...
      <Grid container>
        ...
        <Grid item xs={11}>
          <CardHeader
            ...
            title={applist[2].appName}
            subheader={applist[2].publisherName}
          />
        </Grid>
      </Grid>
      <div class="table-responsive">
        <table class="dtab">
          ...
          {index.map((i) => (
            <tr className="drow">
              <td className="dtable">{appdata[3][i].date}</td>
              <td className="dtable">{appdata[3][i].revenue}</td>
              <td className="dtable">{appdata[3][i].adRequest}</td>
              <td className="dtable">{appdata[3][i].adResponse}</td>
              <td className="dtable">{appdata[3][i].impressions}</td>
              <td className="dtable">{appdata[3][i].clicks}</td>
              <td className="dtable">
                {(
                  (appdata[3][i].impressions / appdata[3][i].adResponse) *
                  100
                ).toFixed(2)}
                %
              </td>
