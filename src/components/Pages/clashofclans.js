    ...
    <div>
      ...
      <Grid container>
        ...
        <Grid item xs={11}>
          <CardHeader
            ...
            title={applist[4].appName}
            subheader={applist[4].publisherName}
          />
        </Grid>
      </Grid>
      <div class="table-responsive">
        <table class="dtab">
          ...
          {index.map((i) => (
            <tr className="drow">
              <td className="dtable">{appdata[5][i].date}</td>
              <td className="dtable">{appdata[5][i].revenue}</td>
              <td className="dtable">{appdata[5][i].adRequest}</td>
              <td className="dtable">{appdata[5][i].adResponse}</td>
              <td className="dtable">{appdata[5][i].impressions}</td>
              <td className="dtable">{appdata[5][i].clicks}</td>
              <td className="dtable">
                {(
                  (appdata[5][i].impressions / appdata[5][i].adResponse) *
                  100
                ).toFixed(2)}
                %
              </td>
