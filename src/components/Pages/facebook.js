    ...
    <div>
      ...
      <Grid container>
        ...
        <Grid item xs={11}>
          <CardHeader
            ...
            title={applist[1].appName}
            subheader={applist[1].publisherName}
          />
        </Grid>
      </Grid>
      <div class="table-responsive">
        <table class="dtab">
          ...
          {index.map((i) => (
            <tr className="drow">
              <td className="dtable">{appdata[2][i].date}</td>
              <td className="dtable">{appdata[2][i].revenue}</td>
              <td className="dtable">{appdata[2][i].adRequest}</td>
              <td className="dtable">{appdata[2][i].adResponse}</td>
              <td className="dtable">{appdata[2][i].impressions}</td>
              <td className="dtable">{appdata[2][i].clicks}</td>
              <td className="dtable">
                {(
                  (appdata[2][i].impressions / appdata[2][i].adResponse) *
                  100
                ).toFixed(2)}
                %
              </td>
