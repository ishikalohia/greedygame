    ...
    <div>
      ...
      <Grid container>
        ...
        <Grid item xs={11}>
          <CardHeader
            ...
            title={applist[8].appName}
            subheader={applist[8].publisherName}
          />
        </Grid>
      </Grid>
      <div class="table-responsive">
        <table class="dtab">
          ...
          {index.map((i) => (
            <tr className="drow">
              <td className="dtable">{appdata[9][i].date}</td>
              <td className="dtable">{appdata[9][i].revenue}</td>
              <td className="dtable">{appdata[9][i].adRequest}</td>
              <td className="dtable">{appdata[9][i].adResponse}</td>
              <td className="dtable">{appdata[9][i].impressions}</td>
              <td className="dtable">{appdata[9][i].clicks}</td>
              <td className="dtable">
                {(
                  (appdata[9][i].impressions / appdata[9][i].adResponse) *
                  100
                ).toFixed(2)}
                %
              </td>
