    ...
    <div>
      ...
      <Grid container>
        ...
        <Grid item xs={11}>
          <CardHeader
            ...
            title={applist[5].appName}
            subheader={applist[5].publisherName}
          />
        </Grid>
      </Grid>
      <div class="table-responsive">
        <table class="dtab">
          ...
          {index.map((i) => (
            <tr className="drow">
              <td className="dtable">{appdata[6][i].date}</td>
              <td className="dtable">{appdata[6][i].revenue}</td>
              <td className="dtable">{appdata[6][i].adRequest}</td>
              <td className="dtable">{appdata[6][i].adResponse}</td>
              <td className="dtable">{appdata[6][i].impressions}</td>
              <td className="dtable">{appdata[6][i].clicks}</td>
              <td className="dtable">
                {(
                  (appdata[6][i].impressions / appdata[6][i].adResponse) *
                  100
                ).toFixed(2)}
                %
              </td>
